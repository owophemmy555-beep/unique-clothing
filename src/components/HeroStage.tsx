      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col items-start space-y-6 pt-4 lg:pt-0 z-10">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-4">
            <button
              onClick={onShopClick}
              className="px-8 py-4 rounded-lg bg-[#D4AF37] text-black font-semibold text-sm uppercase tracking-wider hover:bg-[#c49f27] hover:-translate-y-0.5 transition-all duration-200 shadow-lg"
            >
              SHOP NOW
            </button>
